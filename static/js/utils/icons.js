/**
 * Feather/Lucide Monochromatic SVG Icons Library for COS Theta
 * Stroke width: 1.75px, clean geometric engineering aesthetic
 */
...
const Icons = {
  ...
  alert: (size = 18) => `
    <svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="#e7000b" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
